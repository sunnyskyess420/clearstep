...
const TOOLS: Tool[] = [
  ...
  },
  {
    ...
    desc: "All 53 DBT skills across the four modules — Mindfulness, Distress Tolerance, Emotion Regulation and Interpersonal Effectiveness — plus the general skills that frame them. Search it, bookmark it, fill in 16 worksheets, and prep for a group session.",
    chips: ["53 skills", "16 worksheets", "Bookmarks & goals"],
